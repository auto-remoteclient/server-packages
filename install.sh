...
echo ""
echo "────────────────────────────────────────────────────────"
echo "  Info — agent service (run anytime)"
echo "────────────────────────────────────────────────────────"
echo "  Status (running?):  sudo systemctl status remote-dev-agent"
echo "  Logs (live):        journalctl -u remote-dev-agent -f"
echo "  Stop:               sudo systemctl stop remote-dev-agent"
echo ""
echo "================================="
